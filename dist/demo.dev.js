	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				"td",
				null,
				_react2.default.createElement(_index2.default, { value: "1", valueParser: _index.intParser, displayModeClassName: "btn btn-primary",
					onChange: function onChange(value) {
						return console.log("new int value is: " + value);
					} })
			)
		),
		_react2.default.createElement(
			...
			_react2.default.createElement(
				"td",
				null,
				_react2.default.createElement(_index2.default, { value: "10.00", valueParser: _index.floatParser, displayModeClassName: "btn btn-success",
					onChange: function onChange(value) {
						return console.log("new int value is: " + value);
					},
					displayFormat: function displayFormat(value) {
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				"td",
				null,
				_react2.default.createElement(_index2.default, { value: "me@email.com", valueParser: _index.emailParser,
					onChange: function onChange(value) {
						return console.log("new int value is: " + value);
					} })
			)
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				"td",
				null,
				"Raw value (every inpus is walid)"
			),
			_react2.default.createElement(
				"td",
				null,
				_react2.default.createElement(_index2.default, { value: "Some free text", valueParser: _index.genericParser, displayModeClassName: "btn btn-success",
					onChange: function onChange(value) {
						return console.log("new raw value is: " + value);
					} })
			)
		),
		_react2.default.createElement(
			...
			_react2.default.createElement(
				"td",
				null,
				"Custom parser: text length must be at least 5 characters"
			),
			_react2.default.createElement(
				"td",
				null,
				_react2.default.createElement(_index2.default, { value: "more than 5 chars", valueParser: function valueParser(text) {
						return text.trim().length >= 5 ? text.trim() : null;
					},
					onChange: function onChange(value) {
						return console.log("new custom value is: " + value);
					} })
			)
		)
	)
...
_reactDom2.default.render(widget, document.getElementById("container"));

},{"./index":2,"numeral":4,"react":161,"react-dom":5}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.genericParser = exports.emailParser = exports.floatParser = exports.intParser = undefined;

var _inlineEdit = require("./src/inline-edit");

var _inlineEdit2 = _interopRequireDefault(_inlineEdit);

var _valueParsers = require("./src/valueParsers");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _inlineEdit2.default;
exports.intParser = _valueParsers.intParser;
exports.floatParser = _valueParsers.floatParser;
exports.emailParser = _valueParsers.emailParser;
exports.genericParser = _valueParsers.genericParser;

},{"./src/inline-edit":162,"./src/valueParsers":163}],3:[function(require,module,exports){
...
var InlineEdit = function (_Component) {
	...
	function InlineEdit(props) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InlineEdit).call(this));

		_this.state = { edit: false, value: props.value };
		return _this;
	}
	...
	_createClass(InlineEdit, [{
		...
		value: function render() {
			...
			var styles = this.props.displayModeClassName ? { className: this.props.displayModeClassName } : {};
			var showEditor = this.state.edit || this.state.error;
			var displayValue = this.props.displayFormat ? this.props.displayFormat(this.state.value) : this.state.value;
			if (!showEditor) {
				return _react2.default.createElement(
					"a",
					_extends({ href: "javascript:" }, styles, { onClick: function onClick() {
							return _this2.editValueClicked();
						} }),
					displayValue
				);
			} else {
		...
		key: "getEditWidget",
		value: function getEditWidget() {
			var _this3 = this;

			var styles = this.props.editModeClassName ? { className: this.props.editModeClassName } : {};
			var inputClassName = "inline-edit-text-input";
			if (this.state.error) {
			...
			return _react2.default.createElement(
				"span",
				styles,
				_react2.default.createElement("input", { type: "text", ref: "texbox", className: inputClassName,
					autoFocus: "true", value: this.state.value, onChange: function onChange(e) {
						return _this3.onChangeEventHandler(e);
					},
					onBlur: function onBlur(event) {
						return _this3.editorBlured(event);
					}, onKeyDown: function onKeyDown(e) {
						return _this3.onKeyDownRoutine(e);
					} }),
				" ",
				_react2.default.createElement(
					"big",
		...
		key: "getEditIcon",
		value: function getEditIcon() {
			var _this4 = this;

			var iconClassName = "glyphicon glyphicon-ok-circle text-success";
			if (this.state.error) {
				iconClassName = "glyphicon glyphicon-remove-circle text-danger";
			}
			var icon = _react2.default.createElement("i", { className: iconClassName, ariaHidden: "true", onClick: function onClick() {
					return _this4.iconClicked();
				} });
			return icon;
		}
	}, {
		key: "iconClicked",
		value: function iconClicked() {
   ...
   */
		...
		key: "onChangeEventHandler",
		value: function onChangeEventHandler(event) {
			var value = event.target.value;
			var error = this.getValue(value) === null;
			this.setState({ value: value, error: error });
		}
	}, {
		key: "editorBlured",
		value: function editorBlured(event) {
			this.editingFinished(this.getValue(event.target.value));
		}
	}, {
		key: "editValueClicked",
		value: function editValueClicked() {
			this.setState({ edit: true, initialValue: this.state.value }); //enters edit mode
		}
	}, {
		key: "editingFinished",
		value: function editingFinished(value) {
...
InlineEdit.propTypes = {
	...
	valueParser: _react2.default.PropTypes.func.isRequired,
	displayFormat: _react2.default.PropTypes.func,
	displayModeClassName: _react2.default.PropTypes.string,
	editModeClassName: _react2.default.PropTypes.string
};
